...
class AcumosE5API:
    ...
    # (ak983d) Get list of all Acumos Models from Acumos Instance via E5 API
    ...
    def _download_resource_text(self, solution_id: str, artifact_id: str, file_name: str):
        ...
        for revision in self._get_revisions(solution_id):
            if revision['version'] == latest_version:
                ...
                break
        url = self.base_url + "/solutions/" + solution_id + "/revisions/" + revision_id + "/artifacts/" + artifact_id + "/content"
    ...
    # (ak983d) Update the view count of a solution in Mongo DB instance
    ...
    # (ak983d) Update the download count of a solution in Mongo DB instance
    ...
    # (ak983d) Get the view count of a solution in Mongo DB instance
    ...
    # (ak983d) Get the download count of a solution in Mongo DB instance
