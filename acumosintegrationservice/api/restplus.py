...
api_v2 = Api(
    ...
    description='Acumos Integration Service the ability to pull Acumos models from Acumos instance via E5 API.   It also  operationalizes Acumos models into target platform'
)
